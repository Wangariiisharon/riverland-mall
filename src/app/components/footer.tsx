    ...
    <footer className="w-full bg-[#172D44]/6 shadow text-[#00032E] pt-12">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="text-[#00032E]">
          <h4 className="font-semibold mb-4 text-[#00032E]">
            Store Categories
          </h4>
      ...
      <div className="border-t border-gray-400">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center text-sm text-[#00032E] mt-8 mb-10">
          <p>
